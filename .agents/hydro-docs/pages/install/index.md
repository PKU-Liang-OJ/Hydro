<!--
Source: https://raw.githubusercontent.com/hydro-dev/hydro-dev.github.io/docs/content/docs/Hydro/install/index.mdx
Docs URL: https://hydro.js.org/zh/docs/Hydro/install
...
使用 [腾讯云邀请链接(无折扣)](https://curl.qcloud.com/KE7pzCW4) 或 [阿里云邀请链接(15%折扣)](https://www.aliyun.com/minisite/goods?userCode=806xqzxc) 下单购买服务器, 开发者可获约 15% 返现。  

> [!WARNING]

已知天翼云不备案禁止使用 80/443 端口，若不熟悉相关流程建议购买时选择其他服务商。
...
- 开发组不对 docker 部署提供免费技术支持。

第三方面板（如宝塔）用户请注意：
- 部分面板出现多次高危漏洞，为防止数据丢失，请不要在生产环境中使用！
- 开发者不对使用面板导致的任何问题负责。
- 开发组不对第三方面板部署提供免费技术支持。

若您需要付费技术支持，可联系我们的企业微信。
